...
from starlette.middleware.base import BaseHTTPMiddleware # - request, response 사이의 특정 작업 수행
...
class LoggingMiddleware(BaseHTTPMiddleware): # log를 console에 출력하는 용도
